# สรุปสถาปัตยกรรม "Jommarn-Omni ~413M" (Multimodal & 4-Token MTP Evolution)
...
*   **12-Layer Vision Encoder:** เพิ่มระดับชั้นเลเยอร์การมองเห็นเป็น 12 เลเยอร์เต็มพิกัด เพื่อรองรับการสกัดคุณลักษณะ (Features) ภาพถ่ายบิล หน้าเว็บ และลายมือขึ้นมาจากศูนย์ (Train from scratch) อย่างมีประสิทธิภาพ
...
*   **Total Parameters:** ~413 ล้านพารามิเตอร์ (ลดลงจากเดิม 469M เพราะการใช้ Typhoon Tokenizer ที่มีขนาด Vocab Size เล็กลง ช่วยประหยัดพื้นที่ VRAM ให้เหลือที่ว่างสำหรับเพิ่มความฉลาดให้ Vision Encoder)
...
*   **Parameter Size:** ~104M พารามิเตอร์ (เพิ่มความลึกจาก 8 เป็น 12 ชั้น เพื่อการมองเห็นระดับเทพ)
...
## 🏃‍♂️ คู่มือการรัน Jommarn-Omni ~413M
...
### 2. บังคับเคลียร์สถานะสำหรับการเทรนสเปกใหม่ (~413M & Typhoon Tokenizer)
เนื่องจากเราเปลี่ยนขนาด Tokenizer และชั้น Vision **ต้องบังคับรันจากศูนย์ใหม่ที่ Step 0** ด้วยคำสั่ง:
```bash
FORCE_RESET=1 python scripts/train_transformer.py
```
*(ระบบจะล้างข้อมูลเดิมและสร้างโมเดล ~413M ตัวล่าสุดขึ้นมาเรียนรู้ใหม่ทันที)*
...
---
*วิวัฒนาการโดย Antigravity AI - Jommarn-Omni ~413M Engine*
😈📸⚡