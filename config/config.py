...
# Training parameters (Optimized for T4 16GB - Safe Mode)
T_BATCH_SIZE = 8            # ลดลงเหลือ 8 เพื่อให้รันบน T4 (16GB) ได้
T_CONTEXT_LENGTH = 512      # ปรับหน้าต่างการเรียนรู้เป็น 512 เพื่อความประหยัด
...
T_LR = 4e-4                 
T_LR_DECAYED = 4e-5        
T_OUT_PATH = "models/jommarn_omni_206m_t4.pt"
